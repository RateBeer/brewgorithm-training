[![Build Status](https://travis-ci.com/RateBeer/brewgorithm-training.svg?token=T2ttsRBxCEzfp8zVPhTP&branch=dev)](https://travis-ci.com/RateBeer/brewgorithm-training)
